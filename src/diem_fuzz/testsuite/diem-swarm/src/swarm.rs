...
pub struct DiemSwarm {
    label: &'static str,
    diem_node_bin_path: PathBuf,
    fuzzer_node_bin_path: PathBuf,
    cov_node_bin_path: PathBuf,
...
impl DiemSwarm {
    ...
    pub fn configure_fn_swarm(
        ...
        Ok(Self {
            ...
            fuzzer_node_bin_path: diem_node_bin_path.to_path_buf(),
            cov_node_bin_path: diem_node_bin_path.to_path_buf(),
    ...
    pub fn configure_validator_swarm(
        diem_node_bin_path: &Path,
        fuzzer_node_bin_path: &Path,
        cov_node_bin_path: &Path,
        num_nodes: usize,
        config_dir: Option<String>,
        template: Option<NodeConfig>,
    ) -> Result<DiemSwarm> {
        ...
        Ok(Self {
            label: "Validator",
            diem_node_bin_path: diem_node_bin_path.to_path_buf(),
            fuzzer_node_bin_path: fuzzer_node_bin_path.to_path_buf(),
            cov_node_bin_path: cov_node_bin_path.to_path_buf(),
            dir: swarm_config_dir,
            nodes: HashMap::new(),
            config,
    ...
    pub fn launch(&mut self) {
        ...
        for _ in 0..num_attempts {
            match self.launch_attempt(true,0,0) {
                Ok(_) => return,
    ...
    pub fn launch_attempt(&mut self, check_connectivity: bool, num_fuzzer_nodes: usize, num_cov_nodes: usize) -> Result<(), SwarmLaunchFailure> {
