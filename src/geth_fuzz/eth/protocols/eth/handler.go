...
func handleMessage(backend Backend, peer *Peer) error {
	...
	//peer.Log().Info("Receive message!", " Msg type is ", msg.Code, " size is ", msg.Size)
	//peer.Log().Info("Receive message!", " Msg type is ", msg.Code, " size is ", msg.Size, " Payload is ", msg.Payload, " ReceivedAt is ", msg.ReceivedAt)
