    ...
    bcos::protocol::Block::ConstPtr block, std::function<void(Error::Ptr&&)> callback)
{
    ...
    // auto noncelist = block->nonceList();
    bcos::protocol::NonceList nonceList;
    nonceList.push_back(bcos::protocol::NonceType(0));
    nonceList.push_back(bcos::protocol::NonceType(10));
